...
class TakeExam extends Component {
  ...
  onCountDown = () => {
    ...
    var x = setInterval(async () => {
      ...
      if (document.getElementById('time-display') !== null)
        document.getElementById('time-display').innerHTML = `Time Left: ${minutes} : ${seconds}`;
  ...
  render() {
    return (
      <div>
        <h3 id="time-display" style={{ textAlign: "center" }}></h3>
